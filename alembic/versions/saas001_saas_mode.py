...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('tier', postgresql.ENUM('free', 'starter', 'pro', name='subscriptiontier', create_type=False), nullable=False, server_default='free'),
        sa.Column('stripe_customer_id', sa.String(255), nullable=True),
        sa.Column('stripe_subscription_id', sa.String(255), nullable=True),
        sa.Column('billing_status', postgresql.ENUM('active', 'trialing', 'past_due', 'cancelled', 'none', name='billingstatus', create_type=False), nullable=False, server_default='none'),

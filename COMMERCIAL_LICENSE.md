# IA-Core-Tools Commercial License

## Overview

IA-Core-Tools (AICT) is available under a dual licensing model:
...
1. **Full AICT Functionality**
   - Complete access to all AICT features
   - No copyleft obligations
   - Commercial use rights without restrictions

2. **Client Project Rights**
   - Full modification rights for your specific project
   - API integration rights
   - No additional fees for project-related AICT usage
...
4. **Commercial Service Rights**
   - Deploy AICT for commercial services
   - Provide AICT-based services to clients
   - No open-source obligations for modifications
   - Full commercial use rights

## License Boundaries

### What's Free (AGPL 3.0):
- ✅ Community use and development
- ✅ Basic AICT functionality
- ❌ Commercial service provision (requires commercial license)
- ❌ Network use without source disclosure

### What's Commercial License:
- ✅ Commercial service provision
- ✅ Client project modifications
...
This commercial license is proprietary to LKS Next. All rights reserved. Unauthorized use, reproduction, or distribution is strictly prohibited.

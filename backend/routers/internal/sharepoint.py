"""SharePoint sources and Microsoft Graph helper endpoints (mounted under /internal)."""
...
from services.sharepoint.graph_client import GraphAuthError, GraphAccessError
...
from services.sharepoint.worker import enqueue_sync, ConflictError
...
async def search_microsoft_sites(
    ...
    from services.sharepoint.graph_client import GraphClient
    try:

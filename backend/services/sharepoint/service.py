"""SharePoint service layer: CRUD for sources and sync execution."""
...
from services.sharepoint.graph_client import GraphClient, GraphAuthError, GraphAccessError, GraphDeltaExpiredError
...
from schemas.sharepoint_schemas import (
...
class SharePointSourceService:
    ...
    async def create_source(
        ...
        # 2. Create default data structure first (mirrors repository pattern)
        ...
        # 2b. Create linked silo with metadata_definition_id already set

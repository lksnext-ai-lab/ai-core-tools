#!/usr/bin/env python3
"""
Test script for unified service layer
"""
...
async def test_agent_execution_service():
    """Test agent execution service (basic functionality)"""
    print("\n🧪 Testing Agent Execution Service...")
    
    execution_service = AgentExecutionService()
    
    # Test service initialization
    if execution_service.agent_service and execution_service.session_service:
        print("✅ Agent Execution Service initialized successfully")
    else:
        print("❌ Agent Execution Service initialization failed")
        return False
    
    print("✅ Agent Execution Service tests passed!")
    return True


async def main():
    """Run all tests"""
    print("🚀 Starting Unified Service Layer Tests...\n")
    
    tests = [
        test_session_management(),
        test_file_management(),
        test_agent_execution_service()
    ]
    ...
    if success_count == total_count:
        print("🎉 All tests passed! Unified service layer is working correctly.")
        return True
    else:

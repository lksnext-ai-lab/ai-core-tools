            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  />
                  <p className="text-xs mt-2 flex items-start gap-1.5 text-red-700 bg-red-50 border border-red-200 rounded-lg px-3 py-2">
                    ...
                    <span>The template must include <code className="font-mono bg-red-100 px-1 rounded">{'{question}'}</code> for the agent to work properly.</span>
                  </p>
                </div>
              </div>
            </div>
